...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <form action="<?= base_url('createdNilaiMhs') ?>" method="post">
                    <table class="table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <?php
                            $no = 0;
                            foreach ($matakuliah2 as $row) :
                                $no++;
                                ?>
                                <tr>
                                    <td><?= $no ?></td>
                                    <td><?= $row->matakuliah ?></td>
                                    <td><input type="text" class="form-control nilai" name="nilai" placeholder="Masukkan Nilai"></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
